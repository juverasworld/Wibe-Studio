  ...
  return (
    <Section id="fixed-target">
      ...
      <Left data-scroll data-scroll-sticky data-scroll-target="#fixed-target">
        We're fashion studio based in Aba. We create unique designs that will
      ...
      <Right>
        ...
        data-scroll-speed="5"
         ...
         src={img1} alt="Abot us " />
        <img
          data-scroll
          data-scroll-speed="-2"
         src={img2} className="small-img-1" alt="Abot us " />
        <img src={img3} className="small-img-2" alt="Abot us " />
      </Right>
    </Section>
  );
};
